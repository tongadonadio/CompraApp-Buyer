...
public class AdaptadorListPurchasse extends BaseAdapter {
    private static LayoutInflater inflater = null;
    Context context;
    String[][] offers;
    int[] imgs;

    public AdaptadorListPurchasse(Context context, String[][] data, int[] imgs){
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
        final View view = inflater.inflate(R.layout.list_view_element_purchase, null);
